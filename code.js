...
function moveDivAfterLoadAnimations() {
    ...
    setTimeout(() => {
        ...
        document.getElementsByClassName('bxl-github')[0].classList.add('btn2');
        document.getElementsByClassName('bxl-linkedin')[0].classList.add('btn3');
        setTimeout(() => {
            document.getElementsByClassName('bx-envelope')[0].classList.remove('btn1');
            document.getElementsByClassName('bxl-github')[0].classList.remove('btn2');
            document.getElementsByClassName('bxl-linkedin')[0].classList.remove('btn3');
